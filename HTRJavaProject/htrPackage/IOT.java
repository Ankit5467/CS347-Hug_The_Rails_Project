...
public class IOT extends Sensors {
	...
	String visibilityReport() {
		if (this.getVisibility() < 2.0) {
			return "The visibility is " + this.getVisibility() + " miles. Recommendation: Turn on the train"
	...
	String obtainWeather() {
		...
		if (this.getRainRate() < 0.3 && this.getSnowRate() < 0.3) {
			precipitation += "The rate of precipitation is " + (this.getRainRate() + this.getSnowRate())
					+ " inches per hour.";
